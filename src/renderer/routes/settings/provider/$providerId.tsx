  ...
  return (
    <Stack key={baseInfo.id} gap="xxl">
      ...
      <Stack gap="xl">
        ...
        {/* API Key */}
        {!isOAuthOnlyProvider &&
          ![ModelProviderEnum.Ollama, ModelProviderEnum.LMStudio, ModelProviderEnum.Bedrock, ModelProviderEnum.VertexAI, ''].includes(
            baseInfo.id
          ) && (
        ...
        {baseInfo.id === ModelProviderEnum.VertexAI && (
          <>
            <Stack gap="xxs">
              <Text span fw="600">
              ...
              <TextInput
                flex={1}
                value={providerSettings?.project || ''}
            ...
            <Stack gap="xxs">
              ...
              <TextInput
                flex={1}
                value={providerSettings?.location || ''}
            ...
            <Stack gap="xxs">
              ...
              <PasswordInput
                flex={1}
                value={providerSettings?.apiKey || ''}
                placeholder={t('Leave empty to use Application Default Credentials')}
                onChange={(e) =>
                  setProviderSettings({
                    apiKey: e.currentTarget.value,
                  })
            ...
            <Flex gap="xs" align="center">
              <Tooltip
                disabled={!!providerSettings?.project && displayModels.length > 0}
                label={
                  !providerSettings?.project
                    ? t('Google Cloud Project ID is required to check connection')
                    : displayModels.length === 0
                      ? t('Add at least one model to check connection')
                      : null
                }
