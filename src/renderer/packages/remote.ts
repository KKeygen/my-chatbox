...
// Update check removed — no tracking network request.
...
export async function getDialogConfig(_params: { uuid: string; language: string; version: string }): Promise<DialogConfig | null> {
  // Promotional dialog config fetch removed — returns null (no dialog shown).
  return null
}
